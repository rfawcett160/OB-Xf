...
execute_process(
  COMMAND "C:/Program Files/Git/mingw64/bin/git.exe" --git-dir=.git show-ref "v0.8.2"
  WORKING_DIRECTORY "C:/Users/robfa/Documents/OB-Xf/Builds/Release/_deps/simde-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'C:/Users/robfa/Documents/OB-Xf/Builds/Release/_deps/simde-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/Users/robfa/Documents/OB-Xf/Builds/Release/_deps/simde-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
