...
static_assert("b7af80d"[0] != '\0',
              "GIT_COMMIT_HASH not defined. Run cmake/git-version-functions.cmake commands to use "
              "this library");
namespace sst::plugininfra
{
// clang-format off
const char *VersionInformation::git_commit_hash{"b7af80d"};
const char *VersionInformation::git_branch{"main"};
const char *VersionInformation::git_tag{"Nightly"};
const char *VersionInformation::git_implied_display_version{"Local-2025-07-18"};
...
const char *VersionInformation::build_date{""};
const char *VersionInformation::build_year{""};
const char *VersionInformation::build_time{""};
// clang-format on
} // namespace sst::plugininfra
